...
INSERT INTO utilisateur (nom,prenom,e_mail,num_tel,date_naissance,login,mot_passe) 
		...
		('Bates','Merritt','viverra.Maecenas@iaculis.net','0133651953','08/09/89','Mauris','risus.'),
		...
		('Mcmahon','Christine','Phasellus.ornare@id.edu','0692431077','06/10/87','enim','quam,'),
		...
		('Solis','Edward','egestas@conubia.co.uk','0700555284','11/03/86','malesuada','suscipit'),
		...
		('Love','Mason','egestas.urna.justo@fringillaDonecfeugiat.org','0237859835','20/04/04','mauris.','consequat,'),
		('George','Travis','ultrices.posuere.cubilia@dui.net','0252963036','13/01/88','ac','sollicitudin'),
		...
		('Cervantes','Tamekah','Integer@orciDonec.co.uk','0385554743','20/10/01','ac','enim.'),
		...
		('Dominguez','Alexa','eleifend.nec.malesuada@necmalesuada.edu','0489309113','29/08/89','nibh','Fusce'),
		...
		('Prince','Yoshio','tellus@urnaNuncquis.org','0999664638','09/03/83','Quisque','arcu'),
		('Watts','Cally','placerat@Nam.edu','0593638676','24/04/81','eget','nibh'),
		...
		('Hubbard','Unity','lacus.vestibulum@justofaucibuslectus.net','0893051609','24/12/00','nascetur','porttitor'),
		...
		('Lara','Martha','Aliquam@fermentummetus.com','0640773117','01/08/87','nisl.','egestas.'),
		('Bullock','Coby','Aenean@orci.co.uk','0433715921','20/04/86','ipsum','enim.'),
		 ...
		 ('Obrien','Wade','turpis.Aliquam.adipiscing@consequat.edu','0319580592','13/08/72','Praesent','enim.'),
		...
		('Bray','Kameko','auctor.non@dictumultricies.org','0219187751','14/02/88','et,','hendrerit'),
		 ...
		 ('Richardson','Thomas','urna.Vivamus.molestie@Phasellusornare.com','0371332750','16/01/79','ac','quis'),
